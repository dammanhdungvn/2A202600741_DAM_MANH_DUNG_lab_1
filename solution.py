...
def compare_models(prompt: str) -> dict:
    ...
    return { "gpt4o_response": gpt4o_response, "mini_response": mini_response, "gpt4o_latency": gpt4o_latency, "mini_latency": mini_latency, "gpt4o_cost_estimate": gpt4o_cost_estimate, }


_SAFE_MODULE_NAME = __name__.split(".")[-1]
if _SAFE_MODULE_NAME != __name__:
    # Provide a safe alias so unittest.mock.patch can resolve the module name.
    sys.modules[_SAFE_MODULE_NAME] = sys.modules[__name__]
    compare_models.__module__ = _SAFE_MODULE_NAME
